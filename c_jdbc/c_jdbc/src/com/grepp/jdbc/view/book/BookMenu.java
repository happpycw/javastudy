...
public class BookMenu {
    ...
    public void menu() {
        ...
        do {
            ...
            System.out.println(" * 2. 도서 등록");              // insert
            System.out.println(" * 3. 도서 소개 수정");         // update
            System.out.println(" * 4. 도서 삭제");              // delete
    ...
    private RegistForm bookForm() {
        Scanner sc = new Scanner(System.in);
        RegistForm book = new RegistForm();
